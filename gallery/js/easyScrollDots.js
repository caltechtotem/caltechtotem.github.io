...
function easyScrollDots(dotfixedOptions) {
    ...
    if (scrollIndi.length) {
        ...
        document.getElementById("main-container").lastElementChild.insertAdjacentHTML('afterend', scrollIndiTemplate);
        ...
        const handleIndiScroll = dotsThrottle(function () {
            ...
            Object.keys(indiScrollTopCollection).forEach(function (e) {
                if (indiScrollTopCollection[e] == indiOffsetMin()) {
                    ...
                    [document.getElementById('title-container'), ...document.getElementsByClassName('exhibit-container')].forEach(container => {
                        if (container.classList.contains('in-focus')) {
                    ...
                    document.getElementById(e).classList.add('in-focus');
                    [...document.getElementById(e).children].forEach(child => {
                        child.classList.add('in-focus');
                    });
                }
            });
      ...
      document.getElementById('main-container').addEventListener('scroll', handleIndiScroll);
    }
};
...
function scrollIndiClicked(indiId) {
    if (window.jQuery) {
        ...
        if (dotFixedNavPresent === true && dotFixedNavId.length) {
            ...
            // normal scroll
            document.getElementById(indiId).scrollIntoView({
                behavior: 'smooth'
            });
        }
    }
